...
{title, subtitle, caption, imgSrc}
<section className="text-gray-700 body-font">
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Leaf features</h1>
      <p className="lg:w-1/2 w-full leading-relaxed text-base">Display and track all of your reading activity and content in one place.</p>
    </div>
